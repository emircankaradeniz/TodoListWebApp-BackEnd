...
import com.example.todoWebApplication.config.JWTAuthFilter;
...
public class UsersManagementService {
    ...
    public OurUsers updateUser(Long userId, OurUsers updatedUser, Authentication authentication) {
        // Giriş yapan kullanıcının e-posta adresini alın
        String currentUserEmail = authentication.getName();
        OurUsers existingUser = usersRepo.findById(userId)
                .orElseThrow(() -> new RuntimeException("User not found"));

        // Kullanıcının kendi profilini güncelleyip güncellemediğini kontrol edin
    ...
    public OurUsers getUserProfile(String email) {
